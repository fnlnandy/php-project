<?php
    class WorkerSelectOptions {
        public static function PopulateSelectOptionIds() {
            $query = SQLQuery::ExecQuery("SELECT NumEmp FROM EMPLOYE ORDER BY LENGTH(NumEmp) ASC, NumEmp ASC;");
        ...
        public static function PopulateSelectOptionNames() {
            $query = SQLQuery::ExecQuery("SELECT Nom, Prenom FROM EMPLOYE ORDER BY LENGTH(NumEmp) ASC, NumEmp ASC;");
